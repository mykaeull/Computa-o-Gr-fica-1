...
typedef struct Scene
{
    ...
    {
        Vector w = Vector(p0.x - plane.p_pi.x, p0.y - plane.p_pi.y, p0.z - plane.p_pi.z, 0);
    ...
    {
        Vector Pi_sub_base = Vector(Pi.x - object.base.x, Pi.y - object.base.y, Pi.z - object.base.z, 0);
        return (dot(Pi_sub_base, object.u) < 0 || dot(Pi_sub_base, object.u) > object.h);
    }

    bool is_in_base(Vector P, Object plane, Object object)
    {
        Vector CP = Vector(P.x - plane.p_pi.x, P.y - plane.p_pi.y, P.z - plane.p_pi.z, 0);
    ...
    pair<double, double> intersect_ray_cylinder(Vector p0, Vector D, Object cylinder)
    {
        ...
        Vector p0_sub_base = Vector(p0.x - cylinder.base.x, p0.y - cylinder.base.y, p0.z - cylinder.base.z, 0);
    ...
    Color define_color(double closest_t, Object object, Vector p0, Vector D, Color pixel_image)
    {
        ...
        {
            Vector CP = Vector(pi.x - object.base.x, pi.y - object.base.y, pi.z - object.base.z, 0);
